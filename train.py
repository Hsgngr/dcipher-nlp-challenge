...
#x1 = Dropout(0.5)(x1)
x2 = Bidirectional(LSTM(128, dropout=0.3, recurrent_dropout=0.3, kernel_regularizer=regularizers.l2(0.01)))(abstract_emb)
#x2 = Dropout(0.5)(x2)
...
history = model.fit([sequence_title, sequence_abstract],y_train, epochs=20, validation_data=([sequence_unseen_title,sequence_unseen_abstract],y_test))
...
history = model.fit([sequence_title, sequence_abstract],y_train, epochs=5, validation_data=([sequence_unseen_title,sequence_unseen_abstract],y_test))
